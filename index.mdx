...
import canooInterior from "./images/canoo_interior.jpeg";

export default LandingLayout;

<div
  style={{
    background: `linear-gradient( rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6) ), url('${canooInterior}')`,
    backgroundSize: "cover",
  }}
>
  <Jumbotron bgColor="transparent" parallaxEffect>
    <NavBar location={props.location} standalone={false} />
    <H1>Canoo Developer Portal</H1>
